  ...
  <div class="container">
    <nav class="navbar">
      <div class="navbar-brand">
        ...
        <router-link v-else key="NavbarNotLogged" to="/login" class="navbar-item"
          >Авторизация</router-link
        >
        <div class="navbar-burger burger" data-target="navMenu" :class="active" @click="toggle">
          <span></span>
          <span></span>
          <span></span>
        </div>
          ...
          <div class="navbar-item has-dropdown is-hoverable">
            ...
            <div class="navbar-dropdown is-right">
              <div class="field navbar-item">
                <bulma-button key="user" text="Выход" color="info" @click="logout"></bulma-button>
              </div>
            </div>
          </div>
        </div>
