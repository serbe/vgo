<template>
  <div class="min-h-screen">
    <div class="w-full bg-white dark-mode:bg-gray-800 dark-mode:text-gray-200 text-gray-700">
      <div
        x-data="{ open: false }"
      ...
      >
        ...
        >
          ...
          <div class="relative" x-data="{ open: false }" v-click-away="closeOpen">
            ...
            >
              <div class="bg-white dark-mode:bg-gray-800 px-2 py-2 rounded-md shadow">
                <a
